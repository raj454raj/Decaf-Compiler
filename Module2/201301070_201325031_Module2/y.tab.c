...
#define ARITH_SAIYAN 268
#define ARITH_SUPER_SAIYAN 269
#define REL_OP 270
#define EQ_OP 271
#define COND_OP 272
...
{
       0,    40,    40,    44,    48,    52,    57,    58,    60,    61,
      63,    69,    77,    85,    87,    91,    94,    98,   101,   103,
     106,   110,   111,   112,   113,   114,   115,   116,   118,   119,
     127,   128,   134,   135,   141,   142,   144,   145
};
#endif
...
{
  "$end", "error", "$undefined", "CLASS", "CALLOUT", "TYPE",
  "INT_LITERAL", "STRING_LITERAL", "BOOL_LITERAL", "CHAR_LITERAL", "ID",
  "CHAR", "ASSIGN_OP", "ARITH_SAIYAN", "ARITH_SUPER_SAIYAN", "REL_OP",
  "EQ_OP", "COND_OP", "','", "'{'", "'}'", "'['", "']'", "';'", "'('",
  "')'", "'-'", "'!'", "$accept", "int_literal", "bool_literal",
  "char_literal", "program", "stmt_list", "field_list", "type", "loc_list",
  "field_decl", "callout", "stmt_decl", "location", "expr", "expr_saiyan",
  "expr_super_saiyan", "expr_saiyan_god", "args", YY_NULLPTR
};
#endif
...
static const yytype_uint16 yytoknum[] =
{
     ...
     265,   266,   267,   268,   269,   270,   271,   272,    44,   123,
     125,    91,    93,    59,    40,    41,    45,    33
};
# endif
...
{
      17,    -4,    25,    19,   -21,   -21,    35,   -21,     3,    31,
     -21,    23,    27,   -21,    26,   -21,    38,    30,    -6,    45,
      -5,   -21,    -5,    47,    31,   -21,    -7,   -21,   -21,   -21,
      -5,    -5,    -5,   -21,   -21,   -21,   -21,   -21,    41,    42,
      20,    11,    33,   -21,    -5,   -21,    -1,   -21,   -21,    -5,
      -5,    -5,    -5,    -5,   -21,   -21,   -21,    28,    21,   -21,
     -21,   -21,    -8,    40,   -21,    -5,   -21,   -21
};
...
{
       0,     0,     0,     0,     1,     9,     7,    10,     0,     0,
       8,     0,    19,     5,     0,     6,     0,    11,     0,     0,
       0,    18,     0,     0,     0,    14,     0,     2,     3,     4,
       0,     0,     0,    23,    24,    22,    21,    28,    30,    32,
       0,     0,     0,    13,     0,    15,     0,    25,    26,     0,
       0,     0,     0,     0,    20,    17,    12,    36,     0,    27,
      29,    31,    33,    35,    34,     0,    16,    37
};

  /* YYPGOTO[NTERM-NUM].  */
static const yytype_int8 yypgoto[] =
{
     -21,   -21,   -21,   -21,   -21,   -21,   -21,   -21,    34,   -21,
     -21,   -21,    51,    -2,    12,    10,   -20,    -3
};

  /* YYDEFGOTO[NTERM-NUM].  */
static const yytype_int8 yydefgoto[] =
{
      -1,    33,    34,    35,     2,     8,     6,     9,    18,    10,
      14,    15,    36,    37,    38,    39,    57,    58
};
...
{
      40,    27,    41,    28,    29,    12,     3,    11,    52,    53,
      46,    44,    24,    12,    51,    52,    53,    25,    45,    30,
       1,    31,    32,    13,    59,     4,    51,    52,    53,    47,
      48,    62,    63,    64,    55,    51,    52,    53,     5,    65,
       7,    17,    54,    51,    52,    53,    66,    19,    20,    21,
      22,    23,    26,    42,    49,    56,    50,    53,    43,    16,
      61,    60,    67
};

static const yytype_uint8 yycheck[] =
{
      20,     6,    22,     8,     9,    10,    10,     4,    16,    17,
      30,    18,    18,    10,    15,    16,    17,    23,    25,    24,
       3,    26,    27,    20,    25,     0,    15,    16,    17,    31,
      32,    51,    52,    53,    23,    15,    16,    17,    19,    18,
       5,    10,    22,    15,    16,    17,    25,    24,    21,    23,
      12,    21,     7,     6,    13,    22,    14,    17,    24,     8,
      50,    49,    65
};
...
{
       0,     3,    32,    10,     0,    19,    34,     5,    33,    35,
      37,     4,    10,    20,    38,    39,    40,    10,    36,    24,
      21,    23,    12,    21,    18,    23,     7,     6,     8,     9,
      24,    26,    27,    29,    30,    31,    40,    41,    42,    43,
      44,    44,     6,    36,    18,    25,    44,    41,    41,    13,
      14,    15,    16,    17,    22,    23,    22,    44,    45,    25,
      42,    43,    44,    44,    44,    18,    25,    45
};
...
#line 135 "exp.y" /* yacc.c:1646  */
    {
                    if(!strcmp((yyvsp[-1].str_val), "<"))
                        fputs("LESS THAN ENCOUNTERED\n", bison_output);
                    else if(!strcmp((yyvsp[-1].str_val), ">"))
